...
<head>
  ...
  <title>Heart Fund Platform - Register</title>
  <style>
    * {
      margin: 0;
      padding: 0;
    ...
    .form {
      ...
      max-width: 550px;
      min-height: 80vh;
      margin: 90px auto 40px; /* margin top to clear fixed header */
      padding: 30px 25px;
...
<body>
  ...
  <section class="form">
    <form action="/register" method="POST">
      @csrf
      <h1>Register Here for Donation</h1>
      ...
      <input type="text" name="coming_from" placeholder="Where are you from?" required />
      ...
      <p>
        ...
        <a href="/login" style="font-size: 1rem; color: rgb(200, 230, 250); text-decoration: underline;">Login</a>
      </p>
    </form>
  </section>
